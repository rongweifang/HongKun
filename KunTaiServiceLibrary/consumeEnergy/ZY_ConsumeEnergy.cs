...
, [BX_GS_YL], [BX_HS_YL], [BX_RL], [BX_HRQ], [BSL_QM_SN], [BSL_QM_SW], [BSL_ZM_SN], [BSL_ZM_SW], [BSL_RHJ_SN], [BSL_RHJ_SW], [DYL_QM_XHB]
...
[BX_GS_YL]=@BX_GS_YL, [BX_HS_YL]=@BX_HS_YL, [BX_RL]=@BX_RL, [BX_HRQ]=@BX_HRQ, [BSL_QM_SN]=@BSL_QM_SN, [BSL_QM_SW]=@BSL_QM_SW, [BSL_ZM_SN]=@BSL_ZM_SN, [BSL_ZM_SW]=@BSL_ZM_SW, [BSL_RHJ_SN]=@BSL_RHJ_SN, [BSL_RHJ_SW]=@BSL_RHJ_SW, [DYL_QM_XHB]=@DYL_QM_XHB, 
...
, [BX_HS_YL], [BX_RL], [BX_HRQ], [BSL_QM_SN], [BSL_QM_SW]
, [BSL_ZM_SN], [BSL_ZM_SW], [BSL_RHJ_SN], [BSL_RHJ_SW], [DYL_QM_XHB]
...
BSL_RHJ_SN, BSL_RHJ_SW, (BSL_RHJ_SN + BSL_RHJ_SW) AS BSL_HJ,
DYL_RHJ_XHB, DYL_RHJ_NXHRQ, DYL_RHJ_DBXHRQ, DYL_RHJ_WHXC,
...
ORDER BY ADDDATETIME";
            ...
            try
            {
                ...
                result = new DataAccessHandler().executeNonQueryResult(
                    ...
                    SqlServer.GetParameter(xml, new string[] {
                        ...
                        "BSL_QM_SN", "BSL_QM_SW", "BSL_ZM_SN", "BSL_ZM_SW", "BSL_RHJ_SN", "BSL_RHJ_SW",
        ...
        private string getDataItemXml(ref DataSet dataSetConsumeEnergy, string total)
        {
            ...
            foreach (DataRow row in dataSetConsumeEnergy.Tables[0].Rows)
            {
                ...
                xml.AppendFormat("<DATA NUM=\"{0}\" ID=\"{1}\" ADDDATETIME=\"{2}\" RL=\"{3}\" HRQ=\"{4}\" BSL_RHJ_SN=\"{5}\" BSL_RHJ_SW=\"{6}\" DYL_RHJ_XHB=\"{7}\" DYL_RHJ_NXHRQ=\"{8}\" DYL_RHJ_DBXHRQ=\"{9}\" DYL_RHJ_WHXC=\"{10}\" YQL_RHJ_DBX=\"{11}\" YQL_RHJ_NX=\"{12}\"/>",
